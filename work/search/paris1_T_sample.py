...
truept = [np.log10(m1), np.log10(m2), a, p0, e0, T]
external_lhs_points        = inverse_prior_transform(np.array([truept]))
external_lhs_log_densities = log_density(prior_transform(external_lhs_points))


print('Starting point (phys):', truept)
...
#1-6: 1e5 runs
#7+: 5e5 runs
savepath = dir_scratch+'paris1/sample_T'
