...
ndim = 6
n_seed = 1
paris1_cov = np.array([[ 0.32580461, -0.01958738, -0.01455947, -0.02914656,  0.00807874],
...
init_cov = np.pad(paris1_cov, ((0, 1), (0, 1)), mode="constant")
init_cov[-1, -1] = 1e-6
init_cov_list = [init_cov / anneal_state['S']]
...
# Start from best fit
best_fit = [6.02770973, 1.11882518, 0.68188057, 9.12351337, 0.32140942, 3/12]
