"""
Greedy hill-climber using loglike_timeonly — parallel version.
...
print(f"[{SEED_IDX}] Initializing loglike_timeonly...")
...
print(f"[{SEED_IDX}] Evaluating start with timeonly loglike...")
logden_max = eval_loglike(p_max)
print(f"[{SEED_IDX}] Starting logden (timeonly): {logden_max:.4f}")
...
# ── Save ──────────────────────────────────────────────────────────────────────
os.makedirs('/nfs/home/svu/e1498138/localgit/FEWNEW/work/search/greedy_timeonly_results', exist_ok=True)
savepath = f'/nfs/home/svu/e1498138/localgit/FEWNEW/work/search/greedy_timeonly_results/seed{SEED_IDX:02d}.pkl'
results = {
    'seed_idx':       SEED_IDX,
