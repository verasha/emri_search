...
# append T=3/12 as 6th column
T_col = np.full((len(_phys_pts), 1), 3/12)
_phys_pts = np.concatenate([_phys_pts, T_col], axis=1)
...
#1-6: 1e5 runs
#7+: 5e5 runs
savepath = dir_scratch+'paris1/int_3mth_snr32_dur_2'
