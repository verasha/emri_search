...
Loads paris2_noise/int_3mth_noise_6 to get ellipse center and covariance.
...
# ── Load paris2_noise/int_3mth_noise_6 for ellipse center and covariance ──────
...
paris2_noise_path = '/scratch/e1498138/paris2/int_TDI/sampler_state.pkl'
...
N_SIGMA_OTHER = 3.0
N_SIGMA_E0    = 3.0
N_SIGMA_PER_DIM = np.array([N_SIGMA_OTHER, N_SIGMA_OTHER, N_SIGMA_OTHER,
                             N_SIGMA_OTHER, N_SIGMA_E0])
...
savepath = f'/scratch/e1498138/paris3/lhs_f.pkl'
...
save_data = {
    ...
    'N_SIGMA_OTHER':     N_SIGMA_OTHER,
    'N_SIGMA_E0':        N_SIGMA_E0,
    'N_LHS':             N_LHS,
    'n_inside':       n_inside,
    'T':              T,
    'dt':             dt,
