...
def prior_transform(u):
    logm1lim = [5.99298, 6.02556]
    logm2lim = [0.99554, 1.01296]
    alim = [0.68539, 0.75309]
    p0lim = [8.69650, 9.08419]
    e0lim = [0.38985, 0.40315]
    t = np.zeros_like(u)
...
savepath = f'{dir_scratch}/paris3/lhs_f.pkl'
...
filepath=f'{dir_scratch}/paris3/int_TDI'
