...
def compute_fisher_parallelotope(ctx: dict,
                                 fisher_params: list,#theta0, starting point
    ...
    # SET UP SEF
    sef = StableEMRIFisher(waveform_class=FastKerrEccentricEquatorialFlux,
    ...
    # COMPUTE FISHER
    Fisher = sef(*fisher_params, T=ctx['T'], dt=ctx['dt'],
            param_names=param_names, add_param_args=additional_kwargs,
            live_dangerously=False, stability_plot=True, der_order=4, Ndelta=8,
